...
-> Exemplo 4 mostra a mesma coisa sendo que lá mostra de forma mais simplificada
*/
...
int main()
{
	...
	*/
	...
	//definindo dois vertices e seus pesos da aresta de volta em que u=0 e v=1
	u = 1;
	v = 0;
	peso = 5;
	...
	//saida da adjacência
	p = adj[1].begin();  //definindo início da lista
	cout << "Origem: " << u << endl;
	cout << "Destino: " << p->v << endl;
	cout << "Peso: " << p->peso << endl;
	cout << endl;

	//definindo dois vertices e seus pesos da aresta de volta em que u=0 e v=2
	u = 2;
	v = 0;
	peso = 3;
	...
	//saida da adjacência
	p = adj[2].begin();  //definindo início da lista
	cout << "Origem: " << u << endl;
	cout << "Destino: " << p->v << endl;
	cout << "Peso: " << p->peso << endl;
